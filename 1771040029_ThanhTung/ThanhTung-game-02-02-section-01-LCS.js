...
class NODE {
	...
	* */
	...
	static RESET ()
	{
		this.SET_NODE = new Map()
		this.SET_CHILDREN = new Set()
	}
}
...
function ANALYSIS (String_01, String_02, FLAG, POSITION_PATH) {
	...
	* */
	...
	let X = FIND_LCS(CloneString_01, CloneString_02, CloneString_01.length - 1, CloneString_02.length - 1)
		if (X === 0)
		{
			REMOVE_ALL_CHILDREN(document.querySelector(`div[data-alias="L_02-container"]`))
			REMOVE_ALL_CHILDREN(document.querySelector(`div[data-alias="L_03-container"]`))
			REMOVE_ALL_CHILDREN(document.querySelector(`div[data-alias="STT-item-option-container"]`))
			
			alert("Bạn hãy đọc lại thật cẩn thận xem nào!")
	...
	* */
	...
	if (FLAG === "HTML")
	{
		let POSITION = document.querySelector(POSITION_PATH)
		let L_01 = POSITION.querySelector(`div[data-alias="L_01-container"]`)
		let L_02 = POSITION.querySelector(`div[data-alias="L_02-container"]`)
		let L_03 = POSITION.querySelector(`div[data-alias="L_03-container"]`)
		...
		let TITLE_01 = document.createElement(`div`)
		let RESULT_01 = document.createElement(`div`)
		
		let TITLE_02 = document.createElement(`div`)
		let RESULT_02 = document.createElement(`div`)
		
		TITLE_01.innerText = "Percentage"
		TITLE_02.innerText = "NumberPath"
		
		RESULT_01.innerText = (LCS[CloneString_01.length - 1][CloneString_02.length - 1] / CloneString_01.length * 1e2).toFixed(2)
		RESULT_02.innerText = PATH_FLAG.size.toString()
		
		TITLE_01.setAttribute("data-alias", "L_03-item-title")
		TITLE_02.setAttribute("data-alias", "L_03-item-title")
		RESULT_01.setAttribute("data-alias", "L_03-item-result")
		RESULT_02.setAttribute("data-alias", "L_03-item-result")
		
		L_03.appendChild(TITLE_01)
		L_03.appendChild(TITLE_02)
		L_03.appendChild(RESULT_01)
		L_03.appendChild(RESULT_02)
